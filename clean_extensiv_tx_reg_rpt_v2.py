...
try:
    ...
    with open('ExtensivTxRegRpt_week1.csv', 'r', encoding='utf-8') as file:
                ...
                for col_idx, value in enumerate(row):
                    ...
                    if headers[col_idx] == "QtyOut":
                        try:
                            ...
                            logging.error(f"Error while reading data, error message: Unable to parse; line_number: {row_num} byte_offset_to_start_of_line: {0} column_index: {col_idx} column_name: 'QtyOut' column_type: INT64 value: '{cleaned_value}'")
                            cleaned_value = None  # Set to None if conversion fails
